    ...
    <div class="bg-white p-8 rounded shadow-md w-96">
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-4">
                ...
                <input type="email" id="email" name="email" value="{{ $email }}" class="w-full p-2 border rounded" required readonly>
            </div>
            ...
            <div>
                <button type="submit" class="w-full bg-pink-400 text-white p-2 rounded">Restablecer Contraseña</button>
            </div>
        </form>
    </div>
</body>
