...
<head>
    ...
    <style>
        body {
            ...
            overflow: hidden; /* Evita desbordamiento en la pantalla */
        }
        ...
        .principal {
            height: calc(100vh - 56px); /* Ajusta altura para no incluir la navbar */
            display: flex;
            overflow: hidden;
        }
        .container {
...
.table {
  table-layout: fixed; /* Keeps columns from resizing */
  width: 100%;
}
