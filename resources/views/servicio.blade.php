  ...
  <div class="row">
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="description-overlay">
          <p>Corte de cabello profesional para todo tipo de rostro.</p>
        </div>
    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="description-overlay">
          <p>Técnica de balayage para un look natural y brillante.</p>
        </div>
        <div class="card-body text-center">
    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="description-overlay">
          <p>Babylights para un brillo sutil y juvenil en tu cabello.</p>
        </div>
        <div class="card-body text-center">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="card">
          ...
          <div class="description-overlay">
            <p>Tinte global para un color intenso y duradero.</p>
          </div>
          <div class="card-body text-center">
      ...
      <div class="col-md-4">
        <div class="card">
          ...
          <div class="description-overlay">
            <p>Mechas tradicionales para dar luz y dimensión al cabello.</p>
          </div>
          <div class="card-body text-center">
      ...
      <div class="col-md-4">
        <div class="card">
          ...
          <div class="description-overlay">
            <p>Alisado permanente para un cabello suave y lacio.</p>
          </div>
          <div class="card-body text-center">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="card">
          ...
          <div class="description-overlay">
            <p>Diseño de uñas creativas y personalizadas.</p>
          </div>
          <div class="card-body text-center">
  ...
  <div class="row">
      <div class="col-md-4">
        <div class="card">
          ...
          <div class="description-overlay">
          <p>El diseño de cejas es un proceso estético que busca dar forma y definir las cejas para realzar la expresión facial y armonizar las características del rostro. Este procedimiento puede variar en técnica y estilo, dependiendo de las preferencias personales y la forma del rostro de cada individuo.</p>
        </div>
          <div class="card-body text-center">
      ...
      <div class="col-md-4">
        <div class="card">
          ...
          <div class="description-overlay">
          <p>Incluye los siguientes servicios: <br>-Prueba de maquillaje <br>-Prueba de peinado <br>-Maquillaje para el dia del evento<br>-Peinado para el dia del evento  <br>-Facial hidratante.</p>
        </div>
          <div class="card-body text-center">
      ...
      <div class="col-md-4">
        <div class="card">
          ...
          <div class="description-overlay">
          <p>La mesoterapia en las caderas se centra en disminuir la grasa localizada y mejorar la apariencia de la piel en esta área. Las soluciones inyectadas ayudan a romper los depósitos de grasa y a reducir la celulitis, favoreciendo una silueta más esbelta y suave. Además, mejora la elasticidad y firmeza de la piel.<br><br>(El precio depende de la cantidad de grasa eliminada y del tamaño de la zona a tratar)</p>
        </div>
          <div class="card-body text-center">
      ...
      <div class="col-md-4">
        <div class="card">
          ...
          <div class="description-overlay">
          <p>Este tratamiento se aplica en los brazos para reducir la grasa localizada y mejorar la flacidez. A través de inyecciones específicas, se estimula la microcirculación y se promueve la eliminación de toxinas. La mesoterapia ayuda a tonificar los músculos, logrando brazos más esculpidos y firmes.<br><br>(El precio depende de la cantidad de grasa eliminada y del tamaño de la zona a tratar)</p>
        </div>
          <div class="card-body text-center">
      ...
      <div class="col-md-4">
        <div class="card">
          ...
          <div class="description-overlay">
          <p>La mesoterapia facial se utiliza para rejuvenecer y revitalizar la piel del rostro. Las inyecciones de nutrientes, antioxidantes y ácido hialurónico ayudan a mejorar la hidratación, elasticidad y luminosidad de la piel. Este tratamiento reduce las arrugas, las líneas de expresión y mejora la apariencia general del rostro, otorgándole un aspecto más fresco y juvenil.<br><br>(El precio depende de la cantidad de grasa eliminada y del tamaño de la zona a tratar)</p>
        </div>
          <div class="card-body text-center">
