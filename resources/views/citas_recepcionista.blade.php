...
<div class="container mt-5">
    ...
    <div class="mb-4 d-flex justify-content-between align-items-center">
        ...
        <form action="{{ route('citas.index') }}" method="GET" class="d-flex">
            <input type="text" name="search" class="form-control me-2" placeholder="Buscar por cliente o fecha" value="{{ request()->get('search') }}">
        ...
        <tbody>
            @foreach($citas as $cita)
                <tr>
                    ...
                    <td>{{ $cita->owner ? $cita->owner->name : 'Desconocido' }}</td>
                    <td>{{ $cita->status }}</td>
